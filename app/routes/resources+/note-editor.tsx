...
export function NoteEditor({ note }: { note?: { id: string; title: string; content: string } }) {
    ...
    return (
        ...
        >
            ...
            <div className={floatingToolbarClassName}>
                ...
                <StatusButton
                    status={
                        noteEditorFetcher.state === 'submitting' ? 'pending' : noteEditorFetcher.data?.status ?? 'idle'
                    }
                    type="submit"
