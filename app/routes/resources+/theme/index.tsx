...
export function ThemeSwitch({ userPreference }: { userPreference?: 'light' | 'dark' }) {
        ...
        <fetcher.Form method="POST" action={ROUTE_PATH} {...form.props}>
            <div className="flex gap-2">
				...
				*/}
                ...
                <button className="flex h-8 w-8 cursor-pointer items-center justify-center">{modeLabel[mode]}</button>
            </div>
